<h2><a href="https://www.geeksforgeeks.org/problems/change-the-string3541/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Change the string</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>s</strong>, the task is to change the complete string to uppercase or lowercase depending on the case of the first character.</span></p>
